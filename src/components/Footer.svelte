...
<footer
    id="Footer"
    data-aos="fade-up"
    class=" py-20 mt-10 sm:py-32 bg-black border-t border-solid border-violet-950 flex flex-col gap-4 sm:gap-8 justify-center items-center z-20"
>
    <p class="px-4 py-22 text-violet-700 font-medium poppins">Se conecte cmg</p>
    <div class="flex flex-col gap-4 items-center justify-center">
        <div
            class="flex flex-row md:justify-center md:mt-10 lg:justify-center gap-6"
        >
            <p>
                <b class=" text-violet-400pr-2 poppins text-violet-400"
                    >Email:
